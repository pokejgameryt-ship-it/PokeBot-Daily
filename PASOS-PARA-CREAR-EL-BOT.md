# 🤖 Guía Paso a Paso - Crear y Configurar PokéBot Daily

---

## FASE 1: CREAR LA APLICACIÓN EN DISCORD

### Paso 1.1: Entrar al Developer Portal
...
1. Click en el botón azul **"New Application"** (esquina superior derecha)
2. En el campo **"NAME"**, escribe: `PokéBot Daily`
3. Marca la casilla **"I agree and acknowledge..."**
4. Click en **"Create"**

### Paso 1.3: Crear el Bot

1. En el menú de la izquierda, click en **"Bot"**
2. Click en el botón **"Add Bot"**
3. Click en **"Yes, do it!"** para confirmar
...
> ⚠️ **IMPORTANTE**: Sin estos permisos, el bot NO puede leer mensajes.

### Paso 1.5: Copiar el Token

1. En la sección **"TOKEN"**, click en **"Reset Token"**
2. Click en **"Yes, do it!"**
...
En la sección **"BOT PERMISSIONS"**, marca:
...
| `#retos-semanales` | EVENTOS (o crea uno) | Retos semanales |
| `#hall-of-fame` | EVENTOS (o crea uno) | Logros y reconocimientos |
...
**Solución:** Activa los Privileged Gateway Intents en el Developer Portal (Paso 1.4)
...
4. Verifica que "Message Content Intent" está activo

### Problema: "Access denied" al ejecutar scripts
...
- [ ] Developer Portal: App creada
- [ ] Developer Portal: Bot añadido
- [ ] Developer Portal: 3 Privileged Intents activados
- [ ] Developer Portal: Token copiado
